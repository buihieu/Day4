...
class DemoArray: ConsoleScreen {
   ...
   // var instantArray: Array?
    ...
    func declareArray() {
        ...
        intArr.append(10) // Add 10 to array
        intArr.append(100) // add 100 to array
        intArr.insert(50, atIndex: 1) // insert 50 to index:    1
        // declare an object array type NSArray content 3 object
        var objArray : NSArray
        objArray = [Rectangle(width: 10, height: 10), Triangle(a: 10, b: 10, c: 10), Square(width: 4), Circle(radius: 2)]
        
        var swiftArray = [AnyObject]() //Swift array content 4 object
