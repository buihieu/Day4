...
class BootLogic: NSObject {
    ...
    class func boot(window:UIWindow){
        ...
        var homework = [SECTION: "HomeWork Day4", MENU:[
            [TITLE: "Day4 Number1",CLASS:"FindMidMinMax"],
            [TITLE: "Day4 Number2",CLASS:"ReverseFile"],
            [TITLE: "Day4 Number 3", CLASS: "DemoAnimalInForest"]
            ]
        ]
     
        mainScreen!.menu = [basic, function, collection, advanced, homework]
